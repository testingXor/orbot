            ...
            public void run() {
                ...
                if (sSocksProxyServerPort == -1) {
                    try {
						...
						may have race with 2 other accesses.
						...
						2. in file, OrbotVpnManager.java, class ANON__OR__TYPE$Thread, method run, 
                ...
                try {
					...
					in file, OrbotVpnManager.java, class ANON__OR__TYPE$Thread, method run, 
